...
public class BaseLineController {
    ...
    public AjaxResult getAll(){
        return AjaxResult.success(baseLineService.getAll());
    }
    /**
     * 通过基线id获取基线关联文档及文档版本
     * @return 返回查询到的文档列表信息
    ...
    public AjaxResult getById(@PathVariable("id")Integer id) {
        ...
        return AjaxResult.error("未查询到响应文文件");
    }
    /**
     * 添加文档到指定基线
     * @param docId 添加的文档id
     ...
     */
    @PostMapping("/add")
    public AjaxResult addDocument(@RequestParam("docId")Integer docId, @RequestParam("versionNo")String docVersion, @RequestParam("baselineId")Integer baseLineId){
